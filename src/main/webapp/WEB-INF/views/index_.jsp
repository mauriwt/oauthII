	...
	<body class="">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo" style="margin-top:0"> <img src="img/logo.png" alt="YAUTH"> </span>
			...
			<div class="project-context hidden-xs">
				...
				<span class="project-selector">YACHAY AUTH</i></span>
		...
		<aside id="left-panel">
			...
			<nav>
				...
				<ul>
					<li class="">
						<a href="index.html" title="blank_"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">HOME</span></a>
					</li>
				</ul>
			</nav>
		...
		<div id="main" role="main">
			...
			<!-- #MAIN CONTENT -->
				...
				<!-- col -->
				<div class="col-xs-12">
					<h2>Autenticación realizada correctamente.</h2>	
				</div>
				<!-- end col -->
		...
		<div class="page-footer">
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					<span class="txt-color-white">Yachay E.P. © 2016-2017</span>
				</div>
			</div>
			<!-- end row -->
		</div>
